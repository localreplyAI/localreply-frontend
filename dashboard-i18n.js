...
// Brand / nav
  ...
  "Langue des communications": {en:'Communication language',de:'Kommunikationssprache',it:'Lingua delle comunicazioni',es:'Idioma de comunicaciones',pt:'Idioma das comunicações',nl:'Communicatietaal',pl:'Język komunikacji'},
...
,
  ...
  'Prise de RDV — 4 modes': {en:'Appointment booking — 4 modes',de:'Terminbuchung — 4 Modi',it:'Prenotazione appuntamenti — 4 modalità',es:'Gestión de citas — 4 modos',pt:'Marcações — 4 modos',nl:'Afsprakenbeheer — 4 modi',pl:'Rezerwacje — 4 tryby'},
  ...
  'SMS alertes business': {en:'Business SMS alerts',de:'SMS-Geschäftsbenachrichtigungen',it:'SMS avvisi business',es:'SMS alertas business',pt:'SMS alertas business',nl:'SMS-zakelijke meldingen',pl:'SMS alerty biznesowe'},
  'Alertes urgences temps réel': {en:'Real-time urgency alerts',de:'Echtzeit-Dringlichkeitswarnungen',it:'Avvisi urgenze in tempo reale',es:'Alertas urgencias tiempo real',pt:'Alertas urgências tempo real',nl:'Realtime urgentiemeldingen',pl:'Alerty pilności w czasie rzeczywistym'},
  'Support prioritaire': {en:'Priority support',de:'Prioritätssupport',it:'Supporto prioritario',es:'Soporte prioritario',pt:'Suporte prioritário',nl:'Prioriteitsondersteuning',pl:'Wsparcie priorytetowe'},
